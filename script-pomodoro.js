...
const startPauseBtSymbol = document.querySelector('.app__card-primary-butto-icon');
...
function iniciarOuPausar(){
    if(intervaloId){
        audioPause.play();
        zerar();
        startPauseBtSymbol.setAttribute('src', './imagens/play_arrow.png');
        return;
    }
    audioPlay.play();
    startPauseBtSymbol.setAttribute('src', './imagens/pause.png');
